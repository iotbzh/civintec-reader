    ...
    constructor(config: any) {
       ...
       /**
        ...
        config.readersConfig.forEach((reader: any, index: number) => {
            ...
            if (reader.type === 'CN56') {
                this.readers[reader.ip] = new CV_CN56(this, reader.ip, reader.port, reader.name, reader.level, reader.wiegandMode, reader.autoConnectReader, this.config.serverConfig.ipAddress, this.config.serverConfig.cn56port);
            }
            if (reader.type === 'CT9') {
